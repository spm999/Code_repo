...
// //     try {
// //       await axios.post(`http://localhost:3000/api/code/versions/${id}/approve`, {}, {
// //         headers: { Authorization: `Bearer ${token}` },
// //       });
...
//   const handleRejectCode = async (id) => {
//     try {
//       await axios.post(`http://localhost:3000/api/code/versions/${id}/reject`, {}, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
const AdminDashboard = () => {
  ...
  const handleApproveCode = async (fileId) => {
    try {
      ...
      const fileRes = await axios.get(`http://localhost:3000/api/code/files/${fileId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      ...
      await axios.post(`http://localhost:3000/api/code/versions/${latestVersion._id}/approve`, {}, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleRejectCode = async (fileId) => {
    try {
      ...
      await axios.post(`http://localhost:3000/api/code/versions/${latestVersion._id}/reject`, {}, {
        headers: { Authorization: `Bearer ${token}` },
      });
